...
import pbs.search_pb2 as search__pb2
...
class SearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ProcessSearch = channel.unary_unary(
                '/pb.SearchService/ProcessSearch',
...
class SearchServiceServicer(object):
    ...
    def ProcessSearch(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_SearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessSearch': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessSearch,
...
class SearchService(object):
    ...
    def ProcessSearch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pb.SearchService/ProcessSearch',
